from gradio import Blocks, Column, Tab, Row, Files, File, Checkbox, Button, Textbox, Slider, Dropdown
...
with Blocks(title="Prompt Tools WebUI", theme=Monochrome()) as application:
    ...
    with Tab("Train"):
        ...
        modelFolderNameTextbox = gr.TextArea(value="myTextGenerator", label="Model folder name", interactive=True, lines=1)
